...
app.scrollbar(id:"table_scrollbar", x:680, y:20, width: 15, height:100, vertical:true, connected_widget:app.get_object_by_id("table")[0])

app.frame(id:"frame", x:20, y:320, width:480, height:230, view_area:[1250,1250])
app.scrollbar(id:"frame_scrollbar_v", x:500, y:320, width: 15, height:245, vertical:true, connected_widget:app.get_object_by_id("frame")[0])
app.scrollbar(id:"frame_scrollbar_h", x:20, y:550, width: 480, height:15, connected_widget:app.get_object_by_id("frame")[0])

app.list(id:"list", table:user_list, x:20, y:20, width:380, height:100, row_height:40, frame:"frame")
app.scrollbar(id:"list_scrollbar", x:400, y:20, width: 15, height:100, vertical:true, connected_widget:app.get_object_by_id("list")[0], frame:"frame")
